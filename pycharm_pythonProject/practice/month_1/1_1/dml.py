...
def insert_test():
    with Session() as session:
        ...
        profiles = [
            Profile(actor_id=actors[0].id, constellation="射手座", blood_type="A", height=165, weight=Decimal("60.50")),
            Profile(actor_id=actors[1].id, constellation="金牛座", blood_type="O", height=175, weight=Decimal("70.20")),
            Profile(actor_id=actors[2].id, constellation="水瓶座", blood_type="B", height=164, weight=Decimal("48.80")),
            Profile(actor_id=actors[3].id, constellation="射手座", blood_type="A", height=180, weight=Decimal("75.30")),
            Profile(actor_id=actors[4].id, constellation="狮子座", blood_type="AB", height=162, weight=Decimal("44.50")),
        ]
